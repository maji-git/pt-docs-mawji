---
title: Tags
description: How to use tag to identify instances.
---

# About Tags

Tags is a set of string which you can use to identify each instances. For example, you may identify an object as "coin". You can do so by adding tag to the object. One instance can have multiple tags
